...
# from parametrized import parametrized_class
from parameterized import parameterized, parameterized_class


@parameterized_class([
    {"map_path": "dv_sim/maps/pp_test_track_skidpad_halfcircle.json"},
    {"map_path": "dv_sim/maps/pp_test_track_single_color_turns.json"},
    ])
class TestPathplanning(unittest.TestCase):
    ...
    def setUp(cls):
        ...
        # map_path = Path("dv_sim/maps/pp_test_track_skidpad_halfcircle.json").resolve()
        map_path = Path(cls.map_path).resolve()
        cls.sim = Simulation(
                map_path=map_path,
